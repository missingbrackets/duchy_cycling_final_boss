"""Coaches page — add and view coaches."""
...
from repositories.coach_repo import create_coach, get_all_coaches, get_coach_by_name
from services.audit import audit_create_coach
...
tab_add, tab_view = st.tabs(["➕ Add Coach", "📋 View Coaches"])
